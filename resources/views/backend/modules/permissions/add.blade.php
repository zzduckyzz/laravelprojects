...
@section('title-admin','Thêm Mới Quyền')
                    ...
                    <div class="col-md-8 margin-auto-div">
                        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                            <div class="form-group {{ $errors->first('name') ? 'has-error' : '' }} ">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control"  placeholder="Tên quyền" name="name" value="{{ old('name') }}">
                                ...
                                <div class="col-sm-9">
                                    <select name="group_permission_id" id="group_permission_id"   class="form-control" style="width: 100%;" tabindex="-1">
                                        ...
                                        @foreach($groupPermission as $group )
                                            <option  @if(old('group_permission_id') == $group->id ) selected ="selected" @endif value="{{$group->id}}">{{$group->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group {{ $errors->first('display_name') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control"  placeholder="Tên Hiển Thị" name="display_name" value="{{ old('display_name') }}">
                            ...
                            <div class="form-group {{ $errors->first('description') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="description" style="resize:vertical" class="form-control" id="description">{{ old('description') }}</textarea>
