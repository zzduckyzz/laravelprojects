...
@section('title-admin','Chỉnh Sửa Nhóm Quyền')
@section('main-content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Chỉnh sửa nhóm quyền</a></li>
        </ol>
    </section>
                    ...
                    <div class="col-md-8 margin-auto-div">
                        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                            <div class="form-group {{ $errors->first('name') ? 'has-error' : '' }} ">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control"  placeholder="Tên nhóm quyền" name="name" value="{{ old('name', isset($groupPermission->name)? $groupPermission->name : NULL) }}">
                            ...
                            <div class="form-group {{ $errors->first('description') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="description" style="resize:vertical" class="form-control">{{ old('description', isset($groupPermission->description)? $groupPermission->description : NULL) }}</textarea>
