...
@section('title-admin','Chỉnh Sửa Bài Viết')
                    ...
                    <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <img src="{!! asset(replaceUrlImage($new->image_preview)) !!}" alt="" class="margin-auto-div img-rounded"  id="image_render" style="width: 84%; height: 260px; float: left;">
                            </div>
                        ...
                        <div class="col-md-8">
                            <div class="form-group {{ $errors->first('title') ? 'has-error' : '' }} ">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control"  placeholder="Tiêu đề " name="title" value="{{old('title', isset($new->title) ? $new->title : '')}}">
                                ...
                                <div class="col-sm-9">
                                    <select name="categori_id" id="categori_id"   class="form-control" style="width: 100%;" tabindex="-1">
                                        ...
                                        @foreach($categories as $cate )
                                            <option  @if(old('categori_id', isset($new->categori_id) ? $new->categori_id : '') == $cate->id ) selected ="selected" @endif value="{{$cate->id}}">{{$cate->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group {{ $errors->first('meta_key') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="meta_key" style="resize:vertical" class="form-control" id="meta_key">{{ old('meta_key', isset($new->meta_key) ? $new->meta_key : '') }}</textarea>
                            ...
                            <div class="form-group {{ $errors->first('meta_desc') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="meta_desc" style="resize:vertical" class="form-control" id="meta_desc">{{ old('meta_desc', isset($new->meta_desc) ? $new->meta_desc : '') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="checkbox" id="hot" name="hot" value="1" {{ $new->hot == 1 ? 'checked="checked"': '' }}> <label for="hot" class="permission-name">Hot</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group {{ $errors->first('content') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <textarea name="content" style="resize:vertical" class="form-control" id="content">{!! old('content', isset($new->content) ? $new->content : '') !!}</textarea>
